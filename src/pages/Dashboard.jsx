        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-white-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-black-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l-1.5 3.5a1 1 0 00.9 1.5H18" />
                  <circle cx="10" cy="20" r="1" className="text-indigo-600" />
                  <circle cx="18" cy="20" r="1" className="text-indigo-600" />
                </svg>
